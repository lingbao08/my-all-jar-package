...
public class SnowflakeIdUtil {
    ...
    private static Long getDataCenterId() {
        ...
        hostName = StringUtils.isEmpty(hostName) ? System.getenv("USER") : hostName;
...
//        }
        SnowflakeIdUtil snowflake = new SnowflakeIdUtil(1, 1);
        System.out.println("得到的ID："+snowflake.nextId());
